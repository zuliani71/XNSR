...
% This is a script to test XN_Cruncher on the dataset "Lorca 001"
...
FILELIST = {[DATAPATH_IN,SLASH_TYPE,'Lorca_001_E-W.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'Lorca_001_N-S.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'Lorca_001_Z.trc']};
FILE_MATLAB_OUT = [DATAPATH_OUT,SLASH_TYPE,'Lorca_001.mat'];
%
%% Running XN_Cruncher
