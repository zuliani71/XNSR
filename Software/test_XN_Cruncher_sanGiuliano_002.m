...
% This is a script to test XN_Cruncher on the dataset "San Giuliano 002"
...
FILELIST = {[DATAPATH_IN,SLASH_TYPE,'sanGiuliano_002_E-W.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'sanGiuliano_002_N-S.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'sanGiuliano_002_Z.trc']};
FILE_MATLAB_OUT = [DATAPATH_OUT,SLASH_TYPE,'sanGiuliano_002.mat'];
%
%% Running XN_Cruncher
