...
% This is a script to test XN_Cruncher on the dataset "Lorca 002"
...
FILELIST = {[DATAPATH_IN,SLASH_TYPE,'Lorca_002_E-W.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'Lorca_002_N-S.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'Lorca_002_Z.trc']};
FILE_MATLAB_OUT = [DATAPATH_OUT,SLASH_TYPE,'Lorca_002.mat'];
%
%% Running XN_Cruncher
