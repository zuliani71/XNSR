...
% This is a script to test XN_Cruncher on the dataset "San Giuliano 001"
...
FILELIST = {[DATAPATH_IN,SLASH_TYPE,'sanGiuliano_001_E-W.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'sanGiuliano_001_N-S.trc'],...
    [DATAPATH_IN,SLASH_TYPE,'sanGiuliano_001_Z.trc']};
FILE_MATLAB_OUT = [DATAPATH_OUT,SLASH_TYPE,'sanGiuliano_001.mat'];
%
%% Running XN_Cruncher
