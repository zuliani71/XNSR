...
% This is a script to test XN_Cruncher on the dataset "Ferrara"
% included in the "Data" dir of this distribution. This dataset format is
% ASCII logged with the Tromino device.
%
%% CLEANING
clear all;
close all;
...
FILELIST = {[DATAPATH_IN,SLASH_TYPE,'Ferrara_EW.dat'],...
    [DATAPATH_IN,SLASH_TYPE,'Ferrara_NS.dat'],...
    [DATAPATH_IN,SLASH_TYPE,'Ferrara_Z.dat']};
FILE_MATLAB_OUT = [DATAPATH_OUT,SLASH_TYPE,'Ferrara.mat'];
%
%% Running XN_Cruncher
